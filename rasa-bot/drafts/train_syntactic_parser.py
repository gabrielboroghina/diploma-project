...
TRAIN_DATA = [
    ...
    (
        ...
        {
            "heads": [6, 2, 0, 5, 5, 0, 6, 9, 6, 8],
            "deps": ['cine', '-', 'care', '-', '-', 'al cui', 'ROOT', '-', 'când', 'care'],
        }
    ),
    (
    ...
    (
        ...
        {
            "heads": [2, 2, 3, 3, 3, 4],
            "deps": ['-', '-', 'cât de des', 'ROOT', 'ce', 'ce fel de'],
        }
    ),
    (
    ...
    (
        "sezonul de pescuit se finalizează pe 2 iunie",
        {
            ...
            "deps": ["cine", "-", "care", "-", "ROOT", "-", "când", "care"]}
    ),
    (
        "mi-am făcut pașaportul acum un an",
        {
            "heads": [3, 2, 3, 3, 3, 3, 7, 5],
    ...
    (
        "Maria Popescu locuiește pe Bulevardul Timișoara numărul 5",
        {
            ...
            "deps": ["cine", "care", "ROOT", "-", "unde", "care", "care", "care"]}
    ),
    (
    ...
    (
        ...
        {
            "heads": [2, 0, 2, 5, 5, 2],
            "deps": ["cine", "al cui", "ROOT", "cât", "-", "cât timp"]}
    ),
    (
    ...
    (
        "întâlnirea cu managerul este peste o jumătate de oră",
        {
            ...
            "deps": ["cine", "-", "care", "ROOT", "când", "cât", "cât timp", "-", "ce fel de"]}
    ),
    (
    ...
    (
        "săptămâna mea de vacanță de vară este luna viitoare",
        {
            ...
            "deps": ["cine", "al cui", "-", "care", "-", "ce fel de", "ROOT", "când", "care"]}
    ),
    (
    ...
    (
        ...
        {
            "heads": [1, 1, 1, 4, 2, 4, 5],
            "deps": ["cine", "ROOT", "ce", "-", "când", "care", "care"]}
    ),
    (
    ...
    (
        "testul de curs la rețele neurale a fost joi",
        {
            ...
            "deps": ["cine", "-", "care", "-", "care", "ce fel de", "-", "ROOT", "când"]}
    ),
    (
    ...
    (
        ...
        {
            "heads": [1, 1, 1, 4, 2, 4, 1],
            "deps": ["-", "ROOT", "ce", "-", "care", "ce fel de", "când"]}
    ),
    (
        "sesiunea din browser a expirat acum 10 secunde",
        {
            "heads": [4, 2, 0, 4, 4, 4, 7, 5],
            "deps": ["cine", "-", "care", "-", "ROOT", "când", "cât", "cât timp"]}
    ),
    (
    ...
    (
        "prețul canapelei a fost de 1300 de lei",
        {
            ...
            "deps": ["cine", "al cui", "-", "ROOT", "-", "care este", "-", "ce fel de"]}
    ),
    (
    ...
    (
        "prețul ceasului meu Atlantic a fost 500 de lei",
        {
            ...
            "deps": ["cine", "al cui", "al cui", "care", "-", "ROOT", "care este", "-", "ce fel de"]}
    ),
    (
    ...
    (
        "peste 123 de secunde trecem în noul an",
        {
            ...
            "deps": ["când", "cât", "-", "cât timp", "ROOT", "-", "care", "unde"]}
    ),
    (
    ...
    (
        "care este numele de utilizator de github al laborantului de EIM",
        {
            ...
            "deps": ["care este", "ROOT", "cine", "-", "care", "-", "care", "-", "al cui", "-", "care"]}
    ),
    (
        "care este telefonul de la frizerie",
        {
            "heads": [1, 1, 1, 4, 5, 2],
            "deps": ["care este", "ROOT", "cine", "-", "-", "care"]}
    ),
    (
    ...
    (
        "cine a câștigat locul 1 la olimpiada națională de matematică din 2016",
        {
            ...
            "deps": ["cine", "-", "ROOT", "ce", "care", "-", "unde", "care", "-", "care", "-", "care"]}
    ),
    (
    ...
    (
        ...
        {
            "heads": [1, 2, 2, 2, 5, 3],
            "deps": ["cât", "cât timp", "ROOT", "cine", "-", "care"]}
    ),
    (
